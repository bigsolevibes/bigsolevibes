...
const ARTICLE_CONFIGS = [
  ...
  },
  {
    ...
    chapter:    2,
    type:       'spoke',
    driveFile:  'chapter-2-spoke-1-the-man-who-packs.md',
    publishDate: '2026-06-23',
    excerpt:    "Two kinds of men at airport security. One of them already thought about it before he got there.",
    tags:       ['fragrance', 'travel', 'standard'],
    reconcileInstruction: `Light audit. The airport opening is load-bearing — two types, not two people. Keep it. Product specs should remain in scene: the travel set earns its place through the packing problem, not through feature listing. The shower gel section is coherence argument, not instruction — keep that framing. Close: "all anyone is trying to do" — quiet, earned, leave it.`,
  },
  {
    ...
    chapter:    2,
    type:       'spoke',
    driveFile:  'chapter-2-spoke-2-why-cologne-smells-different.md',
    publishDate: '2026-06-30',
    excerpt:    "Same bottle. Different result on you. He thought that was coincidence. It was chemistry.",
    tags:       ['skin chemistry', 'fragrance', 'drydown'],
    reconcileInstruction: `Light audit. Barber voice — direct, technical, never condescending. The chemistry section earns its science because it answers the man's actual confusion. The application section should remain confident instruction, not consumer warning. The close "Two sprays. You already know where." is the Barber's last word — do not touch it.`,
  },
  {
