...
POST_TIME: [post time]
---
IMAGE BRIEF: [Gemini Imagen 4. Square 1:1. No text, no logos. No product placement. REQUIRED: a specific person, a specific moment, a specific emotional hook. Every brief draws from one of three BSV core scenes — (1) The Suit: end of day, still sharp, day shows on him, the hook is what held up all day except what was inside those shoes; (2) The Intimate Moment: shoes come off, everything looks right except one thing, foot care is the gap between his standard and reality; (3) The Athlete: soccer, basketball, baseball — he did all of this on his feet today. Name the person, name the moment, name what he's feeling. Dark, cinematic, warm amber light. REJECTED if: empty room, objects without a person, stock photo composition, no human subject, no story.]
